...
export const CACHE_KEYS = {
  ...
  STACKING_POOL_MEMBERS: "stacking-pool-members",
  REWARD_SLOT_HOLDERS: "reward-slot-holders",
  REWARD_SLOT_HOLDER_ENTRIES: "reward-slot-holder-entries",
  BURNCHAIN_REWARDS: "burnchain-rewards",
  TOTAL_BURNCHAIN_REWARD: "total-burnchain-reward",
};
